  ...
  const content = (
    ...
    >
      ...
      <div
        ...
        style={{
          boxShadow:
            "inset 1px 1px 1px 0 rgba(255, 255, 255, 0.15), inset -1px -1px 1px 1px rgba(0, 0, 0, 0.2)",
        }}
      />
...
export const GlassButton: React.FC<{ children: React.ReactNode; href?: string; className?: string }> = ({
  ...
  >
    <div
      className="transition-all duration-700 hover:scale-95 text-center flex items-center justify-center"
      style={{
        transitionTimingFunction: "cubic-bezier(0.175, 0.885, 0.32, 2.2)",
      }}
    >
